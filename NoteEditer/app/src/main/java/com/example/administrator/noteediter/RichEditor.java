...
public class RichEditor extends WebView {
    ...
    private Class<?> IdentityClassActicityClass;
    ...
    private void addImageClickListner(){
        ...
        loadUrl("javascript:(" +
                "   var imageClick = document.getElementById('ImageIdentifyBox');"+
                "   var imageBoxIdentify = document.getElementById('Identify');"+
                "   var imageBoxDelete = document.getElementById('Delete');" +
                "   var ImageIndex;"+
                "   function(){" +
                ...
                + "                     window.ImageListner.SendImageUrl(this.src, i);  " +
                "                   }" +
                "                   return false;" +
                "               }" +
                "           }  " +
                "       }" +
                "   }" +
                "   imageBoxIdentify.addEventListener(\"touchend\",function(){" +
                "       imageClick.style.display = 'none';" +
                "       window.ImageListner.openIdentity();" +
                "   });" +
                "   imageBoxDelete.addEventListener(\"touchend\",function(){" +
                "       imageClick.style.display = 'none';" +
                "       ImageIndex.parentNode.removeChild(ImageIndex);" +
                "   });" +
                ")()");
    }
    ...
    public class JavascriptInterface {
        ...
        public void SendImageUrl(String img, int i){
            System.out.println(img);
            ImageUrl = img;
        }
        public void openIdentity() {
            Intent intent = new Intent();
            intent.putExtra("IdentityImageUrl", ImageUrl);
            // 跳转到图片识别页面
            intent.setClass(context,IdentityClassActicityClass);
